...
echo ""
echo "Next steps:"
echo "1. Map your custom domain to the Cloud Run service URL"
echo "2. Visit your Ghost admin panel at: ${GHOST_URL}/ghost"
echo "3. Complete the Ghost setup wizard"
echo ""
echo "Useful commands:"
echo "  - View logs: gcloud run services logs read ghost-cms --project=$GCP_PROJECT_ID"
